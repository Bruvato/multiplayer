...
public class BootsrapManager : MonoBehaviour
{

    private static BootsrapManager instance;
    ...
    private void OnLobbyCreated(LobbyCreated_t callback)
    {
        ...
        SteamMatchmaking.SetLobbyData(new CSteamID(CurrentLobbyID), "HostAdress", SteamUser.GetSteamID().ToString());
